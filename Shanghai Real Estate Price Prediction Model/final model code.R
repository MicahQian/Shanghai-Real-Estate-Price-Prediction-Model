...
plot(t,y,main = 'Figure 2:scatterplot of train data and non-linear results', sub = NULL, xlab = 'time', ylab = 'price')
lines(t,yy)
...
#plot actual price and predict price in train data
plot(t,y,xlab='time',ylab='price',pch=19,cex=1.5,col='red',main ='Figure 4: The scatterplot of non-linear model and model')
...
y1fit=c(25096.47,29690.21,35124.81,41554.17)
rmse1=rmse(Xt$y,y1fit)
...
ggtitle("Figure 5: The error rate of non-linear prediction model")
...
rmse5=rmse(Xt$y,reg5.pred[,1])
rmse5

#output summary report for two model 
sumreport=data.frame(Xt$t,Xt$y,y1pred=y1pred[,1],errorrate1,reg5pred=predanre5$fit,errorrate5)
sumreport
describe(errorrate1,type = 2)
describe(errorrate5,type = 2)

#visualize summary report
plot(Xt$t,errorrate1,pch=19,cex=1.5,xlim=c(2014,2017),ylim=c(0,9),col='red',main ='Figure 6: The scatterplot of error rate for regression model between 2014 to 2017')
...
plot(Xt$t,Xt$y,xlab='time',ylab='price',pch=19,cex=1.5,col='red',main ='Figure 7: The scatterplot of Shanghai Real Estate histrionic price')
